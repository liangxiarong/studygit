...
namespace MYSQL
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static DataSet RunProcedureForDs(string storedProcName, IDataParameter[] parameters)
        {
        ...
        #region 事务处理
        public static bool TransactionWithSql(string SQLString)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    {
                        MySqlTransaction transaction = conn.BeginTransaction();//开始事物                   
